...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Samurai samurai = new Samurai(300,26,"Samurai");
        Kamikadze kamikadze = new Kamikadze(350,0,"Kamikadze");
        DemonHunter demonHunter = new DemonHunter(350,25,"Demon");
        Hero[] heroes = {warrior, doc, magic, berserk, assistant,samurai,kamikadze,demonHunter};
